...
public class TempConverter {
    public static void main(String[] args) {
        ...
        while (!tempChoice.equals("C") && !tempChoice.equals("F") && !tempChoice.equals("K")) {

            System.out.println("Not allowed, choose C, F or K");
        ...
        switch (tempChoice) {
            ...
            case "F":
                ...
                double kelvinFromF = celsius + 273.15;
